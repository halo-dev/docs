...
<Tabs>
<Tab value="halo-postgresql" label="Halo + PostgreSQL（推荐）">
...
<Tab value="halo-mysql" label="Halo + MySQL">
...
<Tab value="halo-h2" label="Halo + H2">
...
<Tab value="external-db" label="使用外部数据库">
...
1. 使用 [Nginx Proxy Manager](../install/other/nginxproxymanager.mdx)

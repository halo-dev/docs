---
title: 文章数据列表操作菜单
description: "使用 post:list-item:operation:create 向 Halo Console 文章列表添加自定义操作菜单，读取当前 ListedPost 并配置权限、显隐条件与处理动作"
---
...
import ListedPost from "./interface/_ListedPost.md";

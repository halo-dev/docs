---
title: 页面数据列表操作菜单
description: '使用 single-page:list-item:operation:create 向 Halo Console 页面列表添加自定义操作菜单，读取当前 ListedSinglePage 并配置权限、显隐条件与处理动作'
---
...
import ListedSinglePage from "./interface/_ListedSinglePage.md";

        ...
        <dl className="docs-trial__credentials">
          <div>
            ...
            <dd>
              ...
              <button
                type="button"
                aria-label="复制 Demo 用户名"
                title="复制用户名"
                onClick={() => navigator.clipboard.writeText('demo')}
              >
                <MingcuteCopy2Line width={16} height={16} aria-hidden="true" />
              </button>
            </dd>
          </div>
          <div>
            ...
            <dd>
              ...
              <button
                type="button"
                aria-label="复制 Demo 密码"
                title="复制密码"
                onClick={() => navigator.clipboard.writeText('P@ssw0rd123..')}
              >
                <MingcuteCopy2Line width={16} height={16} aria-hidden="true" />
              </button>
            </dd>
      ...
      <article className="docs-trial__install">
        ...
        <div className="docs-trial__command">
          ...
          <div className="docs-trial__command-body">
            ...
            <button
              type="button"
              aria-label="复制 Docker 快速体验命令"
              title="复制命令"
              onClick={() => navigator.clipboard.writeText('docker run -d --name halo -p 8090:8090 -v ~/.halo2:/root/.halo2 halohub/halo:2.26')}
            >
              <MingcuteCopy2Line width={18} height={18} aria-hidden="true" />
            </button>
          </div>
        </div>

...
1. 创建容器
   ...
   ```bash
   docker run -it -d --name halo -p 8090:8090 -v ~/.halo2:/root/.halo2 -e JVM_OPTS="-Xmx256m -Xms256m" registry.fit2cloud.com/halo/halo-pro:2.25
   ```
...
2. 拉取新版本镜像
   ...
   ```bash
   docker pull registry.fit2cloud.com/halo/halo-pro:2.25
   ```
...
4. 更新 Halo
   ...
   ```bash
   docker run -it -d --name halo -p 8090:8090 -v ~/.halo2:/root/.halo2 registry.fit2cloud.com/halo/halo-pro:2.25
   ```
